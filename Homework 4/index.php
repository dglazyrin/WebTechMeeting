<?php
$job = [
'employer' => ['Titanic', 'МКС', 'Временно безработный'],
'work_time' => ['1912-1912', '1986-2001', '2001-Our days'],
'work_duty' => ['Первый помощник', 'Капитан', 'Образовательный отдых']
]
?>
<!DOCTYPE html>
<html>
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $job['employer'][$i] ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
            <?php echo $job['work_time'][$i] ?>
            </span>
            </h6>
            <p><?php echo $job['work_duty'][$i]?></p>
            <hr>
          </div>
          <?php endfor; ?>
